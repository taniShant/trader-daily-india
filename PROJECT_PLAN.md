...
| P9-WP03 | Fix ECS image deploy workflow | Not started | `.github/workflows/deploy.yml` | dry-run/manual deploy | Builds trading bot and dashboard images and updates ECS predictably. |
| P9-WP04 | Add Oracle deploy workflow/script | Not started | `oracle/scripts/`, `.github/workflows/oracle-deploy.yml` | dry run | Oracle proxy deployment is repeatable. |
