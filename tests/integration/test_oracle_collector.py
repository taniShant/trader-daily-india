...
def test_oracle_collector_maps_nse_symbols_to_breeze_codes(monkeypatch):
    ...
    assert collector_module._breeze_stock_code("BAJAJFINSV") == "BAJFIN"
    ...
    assert collector_module._breeze_stock_code("POWERGRID") == "POWIND"
    assert collector_module._breeze_stock_code("ULTRACEMCO") == "ULTRAC"
    ...
    assert collector_module._breeze_stock_code("UPL") == "UPL"
