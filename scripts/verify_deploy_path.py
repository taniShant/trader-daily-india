...
def main() -> int:
    ...
    assert_contains(deploy, "cdk deploy svc-trd-PlatformStack", ".github/workflows/deploy.yml")
    assert_contains(deploy, "cdk deploy svc-trd-AgentRuntimeStack", ".github/workflows/deploy.yml")
