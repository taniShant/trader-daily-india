...
def main() -> int:
    ...
    assert_contains(deploy, "docker build -f containers/trading-bot/Dockerfile", ".github/workflows/deploy.yml")
    assert_contains(deploy, "docker build -f containers/dashboard/Dockerfile", ".github/workflows/deploy.yml")
